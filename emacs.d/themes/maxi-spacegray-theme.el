...
(let* ((class '((class color) (min-colors 89)))
       ...
       (far-background "medium sea green") ;; panel-control
       ...
       (foreground "#ffffff")
       (comment "#868A95") ;; table-row
       (red "#bf616a") ;; tab-control-hover-tab-close-button
       (orange "#DCA432") ;; darker tab-control-dirty-tab-close-butto
       (bright-orange "#d35400") ;; darker tab-control-dirty-tab-close-butto
       (dark-gray "#3c414c") ;; darker tab-control-dirty-tab-close-butto
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:foreground ,foreground :background ,bright-orange
                                     :family "Lucida Grande"))))
   `(mode-line-buffer-id ((,class (:foreground ,foreground :background nil))))
   `(mode-line-inactive ((,class (:inherit mode-line
                                           :foreground ,subtle
                                           :background ,dark-gray :weight normal
                                           :box nil))))
   ...
   '(evil-search-highlight-persist-highlight-face ((t (:background "yellow1" :foreground "black1"))))
